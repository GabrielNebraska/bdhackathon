    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cargo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='funcionarios', to='hackathon.cargo')),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='funcionario', to='hackathon.usuario')),
            ],
        ),
        migrations.CreateModel(
            name='Chamado',
            fields=[
                ...
                ('funcionario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hackathon.funcionario')),
            ],
        ),
        migrations.CreateModel(
            name='Orcamentos',
            fields=[
                ...
                ('endereco_cliente', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cliente', to='hackathon.cliente')),
            ],
        ),
        migrations.CreateModel(
            name='Relatorio',
            fields=[
                ...
                ('imagens_antes', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='uploader.image')),
                ('imagens_depois', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='uploader.image')),
            ],
        ),
        migrations.CreateModel(
            name='Servico',
            fields=[
                ...
                ('data_inicio', models.DateField(default=hackathon.models.default_date)),
                ('cliente', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='Cliente', to='hackathon.cliente')),
                ('funcionario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hackathon.funcionario')),
                ('orcamento', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='hackathon.orcamentos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('usuario', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='administrador', to='hackathon.usuario')),
            ],
        ),
    ]
